...
INSERT INTO dbo.AdminUsers (Id, Name, Email, Phone, Role, [Password], [Status], CreatedAt, LastLoginAt, AvatarColor, ManagedPoiId) VALUES (N'user-owner-dessert', N'Phạm Mỹ Linh', N'mylinh@gmail.com', N'0909 188 004', N'PLACE_OWNER', N'Admin@123', N'active', CAST(N'2026-01-05T02:00:00.0000000+00:00' AS datetimeoffset(7)), CAST(N'2026-03-12T07:20:00.0000000+00:00' AS datetimeoffset(7)), N'#7c2d12', N'ca-phe-che');
