...
GO
INSERT INTO dbo.Pois (Id, Slug, AddressLine, Latitude, Longitude, CategoryId, [Status], IsFeatured, District, Ward, PriceRange, TriggerRadius, Priority, OwnerUserId, UpdatedBy, CreatedAt, UpdatedAt, IsActive, LockedBySuperAdmin, ApprovedAt, RejectionReason, RejectedAt) VALUES (N'ca-phe-che', N'ca-phe-che', N'Chung cư H1, Hoàng Diệu, Phường Khánh Hội, Quận 4, TP.HCM, Việt Nam', 10.762195, 106.701499, N'cat-coffee-tea', N'published', 0, N'Quận 4', N'Phường Khánh Hội', N'25.000 - 75.000 VND', 20, 1, N'user-owner-dessert', N'Ánh Xuân', CAST(N'2026-01-16T02:00:00.0000000+00:00' AS datetimeoffset(7)), CAST(N'2026-04-06T06:57:06.9121038+00:00' AS datetimeoffset(7)), 1, 0, CAST(N'2026-04-06T06:57:06.9121038+00:00' AS datetimeoffset(7)), NULL, NULL);
INSERT INTO dbo.Pois (Id, Slug, AddressLine, Latitude, Longitude, CategoryId, [Status], IsFeatured, District, Ward, PriceRange, TriggerRadius, Priority, OwnerUserId, UpdatedBy, CreatedAt, UpdatedAt, IsActive, LockedBySuperAdmin, ApprovedAt, RejectionReason, RejectedAt) VALUES (N'oc-oanh-1', N'oc-oanh-1', N'Ốc Oanh 1, 534 Hẻm 42/237 Đường Hoàng Diệu, 534, Hẻm 42/237 Đường Hoàng Diệu, Phường Khánh Hội, Quận 4, TP.HCM, Việt Nam', 10.761415, 106.702834, N'cat-oc', N'published', 0, N'Quận 4', N'Phường Khánh Hội', N'', 25, 2, N'user-f60f843a', N'Ánh Xuân', CAST(N'2026-04-13T16:45:22.3341660Z' AS datetimeoffset(7)), CAST(N'2026-04-13T16:46:02.6374502Z' AS datetimeoffset(7)), 1, 0, CAST(N'2026-04-13T16:46:02.6262194Z' AS datetimeoffset(7)), NULL, NULL);
INSERT INTO dbo.Pois (Id, Slug, AddressLine, Latitude, Longitude, CategoryId, [Status], IsFeatured, District, Ward, PriceRange, TriggerRadius, Priority, OwnerUserId, UpdatedBy, CreatedAt, UpdatedAt, IsActive, LockedBySuperAdmin, ApprovedAt, RejectionReason, RejectedAt) VALUES (N'oc-phat', N'oc-phat', N'Ốc Phát, Vĩnh Khánh, Phường Khánh Hội, Quận 4, TP.HCM, Việt Nam', 10.761873, 106.702153, N'cat-oc', N'published', 0, N'Quận 4', N'Phường Khánh Hội', N'50.000-110.000', 30, 5, N'user-owner-oc', N'Ánh Xuân', CAST(N'2025-11-19T02:00:00.0000000+00:00' AS datetimeoffset(7)), CAST(N'2026-04-09T16:25:22.2941302+00:00' AS datetimeoffset(7)), 1, 0, CAST(N'2026-04-09T16:25:22.2941302+00:00' AS datetimeoffset(7)), NULL, NULL);
INSERT INTO dbo.Pois (Id, Slug, AddressLine, Latitude, Longitude, CategoryId, [Status], IsFeatured, District, Ward, PriceRange, TriggerRadius, Priority, OwnerUserId, UpdatedBy, CreatedAt, UpdatedAt, IsActive, LockedBySuperAdmin, ApprovedAt, RejectionReason, RejectedAt) VALUES (N'sushi-ko', N'nha-hang-sushi-ko', N'Nhà Hàng Sushi Ko, 122/37/15 Vĩnh Khánh, Phường Khánh Hội, Quận 4, TP.HCM, Việt Nam', 10.760772, 106.704798, N'cat-seafood-raw', N'published', 0, N'Quận 4', N'Phường Khánh Hội', N'50.000-150.000', 25, 3, N'user-owner-bbq', N'Ánh Xuân', CAST(N'2025-11-19T03:15:00.0000000+00:00' AS datetimeoffset(7)), CAST(N'2026-04-09T16:18:37.7903537+00:00' AS datetimeoffset(7)), 1, 0, CAST(N'2026-04-09T16:18:37.7903537+00:00' AS datetimeoffset(7)), NULL, NULL);
GO
