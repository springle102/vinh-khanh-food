...
INSERT INTO dbo.CustomerFavoritePois (CustomerUserId, PoiId) VALUES (N'customer-2', N'poi-bbq-night');
INSERT INTO dbo.CustomerFavoritePois (CustomerUserId, PoiId) VALUES (N'customer-3', N'poi-snail-signature');
GO
INSERT INTO dbo.PoiTags (PoiId, TagValue) VALUES (N'poi-bbq-night', N'hải sản nướng');
INSERT INTO dbo.PoiTags (PoiId, TagValue) VALUES (N'poi-bbq-night', N'nhóm bạn');
INSERT INTO dbo.PoiTags (PoiId, TagValue) VALUES (N'poi-bbq-night', N'ban đêm');
...
GO
INSERT INTO dbo.PoiTranslations (Id, EntityType, EntityId, LanguageCode, Title, ShortText, FullText, SeoTitle, SeoDescription, IsPremium, UpdatedBy, UpdatedAt) VALUES (N'trans-c267c49e', N'poi', N'poi-bbq-night', N'zh-CN', N'Quảng Trường Ẩm thực BBQ Night', N'', N'烧烤之夜是永庆美食街的一大亮点，游客可以在这里通过烤海鲜的香气和热闹的当地氛围，体验西贡充满活力的街头生活。', N'', N'', 1, N'Ánh Xuân', CAST(N'2026-03-21T03:10:22.6481221+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.PoiTranslations (Id, EntityType, EntityId, LanguageCode, Title, ShortText, FullText, SeoTitle, SeoDescription, IsPremium, UpdatedBy, UpdatedAt) VALUES (N'trans-1', N'poi', N'poi-bbq-night', N'vi', N'Quảng trường Ẩm thực BBQ Night', N'Điểm tụ họp sôi động với món nướng hải sản và không khí phố đêm náo nhiệt.', N'BBQ Night là điểm dừng chân nổi bật của Phố ẩm thực Vĩnh Khánh, nơi du khách có thể cảm nhận nhịp sống đường phố Sài Gòn qua hương thơm của hải sản nướng và không khí tụ hội đậm chất địa phương.', N'BBQ Night - Phố Ẩm thực Vĩnh Khánh', N'Điểm nướng hải sản nổi bật cho nhóm bạn và khách du lịch về đêm.', 0, N'Ánh Xuân', CAST(N'2026-03-23T15:09:14.7035213+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.PoiTranslations (Id, EntityType, EntityId, LanguageCode, Title, ShortText, FullText, SeoTitle, SeoDescription, IsPremium, UpdatedBy, UpdatedAt) VALUES (N'trans-2', N'poi', N'poi-bbq-night', N'en', N'BBQ Night Culinary Square', N'A lively seafood grill stop with upbeat local night-street energy.', N'BBQ Night is one of the key anchors of Vinh Khanh Food Street, bringing together fresh grilled seafood, bright urban lights, and an informal local social vibe.', N'BBQ Night at Vinh Khanh Food Street', N'Seafood grill spot for evening food tours in District 4.', 0, N'Minh Ánh', CAST(N'2026-03-18T07:05:00+00:00' AS datetimeoffset(7)));
...
GO
INSERT INTO dbo.AudioGuides (Id, EntityType, EntityId, LanguageCode, AudioUrl, VoiceType, SourceType, [Status], UpdatedBy, UpdatedAt) VALUES (N'audio-5f585e13', N'poi', N'poi-bbq-night', N'zh-CN', N'', N'south', N'tts', N'ready', N'Ánh Xuân', CAST(N'2026-03-21T03:10:22.6039699+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.AudioGuides (Id, EntityType, EntityId, LanguageCode, AudioUrl, VoiceType, SourceType, [Status], UpdatedBy, UpdatedAt) VALUES (N'audio-1', N'poi', N'poi-bbq-night', N'vi', N'https://cdn.example.com/audio/bbq-night-vi.mp3', N'standard', N'tts', N'ready', N'Ánh Xuân', CAST(N'2026-03-23T15:09:14.7659864+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.AudioGuides (Id, EntityType, EntityId, LanguageCode, AudioUrl, VoiceType, SourceType, [Status], UpdatedBy, UpdatedAt) VALUES (N'audio-2', N'poi', N'poi-bbq-night', N'en', N'https://cdn.example.com/audio/bbq-night-en.mp3', N'standard', N'tts', N'ready', N'Minh Ánh', CAST(N'2026-03-18T07:20:00+00:00' AS datetimeoffset(7)));
...
INSERT INTO dbo.AudioGuides (Id, EntityType, EntityId, LanguageCode, AudioUrl, VoiceType, SourceType, [Status], UpdatedBy, UpdatedAt) VALUES (N'audio-4', N'poi', N'poi-sweet-lane', N'vi', N'', N'south', N'tts', N'missing', N'Phạm Mỹ Linh', CAST(N'2026-03-16T07:05:00+00:00' AS datetimeoffset(7)));
GO
...
GO
INSERT INTO dbo.Promotions (Id, PoiId, Title, [Description], StartAt, EndAt, [Status]) VALUES (N'promo-1', N'poi-bbq-night', N'Combo BBQ nhóm 4 người', N'Tặng nước uống cho khách check-in POI trong khung giờ 18h-20h.', CAST(N'2026-03-18T11:00:00+00:00' AS datetimeoffset(7)), CAST(N'2026-03-25T14:00:00+00:00' AS datetimeoffset(7)), N'active');
INSERT INTO dbo.Promotions (Id, PoiId, Title, [Description], StartAt, EndAt, [Status]) VALUES (N'promo-2', N'poi-snail-signature', N'Giảm 10% cho khách nghe audio guide', N'Áp dụng khi khách hoàn tất bài thuyết minh tiếng Việt hoặc tiếng Anh.', CAST(N'2026-03-20T10:00:00+00:00' AS datetimeoffset(7)), CAST(N'2026-03-28T14:00:00+00:00' AS datetimeoffset(7)), N'upcoming');
GO
INSERT INTO dbo.Reviews (Id, PoiId, UserName, Rating, CommentText, LanguageCode, CreatedAt, [Status]) VALUES (N'review-1', N'poi-snail-signature', N'Thu Trang', 5, N'Chạm vào POI trên bản đồ rồi nghe giới thiệu rất tiện và dễ hiểu.', N'vi', CAST(N'2026-03-18T05:00:00+00:00' AS datetimeoffset(7)), N'approved');
INSERT INTO dbo.Reviews (Id, PoiId, UserName, Rating, CommentText, LanguageCode, CreatedAt, [Status]) VALUES (N'review-2', N'poi-bbq-night', N'Lucas', 4, N'Useful overview before starting the food route.', N'en', CAST(N'2026-03-18T08:00:00+00:00' AS datetimeoffset(7)), N'pending');
GO
INSERT INTO dbo.ViewLogs (Id, PoiId, LanguageCode, DeviceType, ViewedAt) VALUES (N'view-1', N'poi-bbq-night', N'vi', N'web', CAST(N'2026-03-13T11:10:00+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.ViewLogs (Id, PoiId, LanguageCode, DeviceType, ViewedAt) VALUES (N'view-2', N'poi-snail-signature', N'en', N'ios', CAST(N'2026-03-13T12:20:00+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.ViewLogs (Id, PoiId, LanguageCode, DeviceType, ViewedAt) VALUES (N'view-5', N'poi-bbq-night', N'zh-CN', N'ios', CAST(N'2026-03-15T13:10:00+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.ViewLogs (Id, PoiId, LanguageCode, DeviceType, ViewedAt) VALUES (N'view-6', N'poi-snail-signature', N'vi', N'android', CAST(N'2026-03-15T18:30:00+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.ViewLogs (Id, PoiId, LanguageCode, DeviceType, ViewedAt) VALUES (N'view-8', N'poi-bbq-night', N'en', N'ios', CAST(N'2026-03-16T19:40:00+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.ViewLogs (Id, PoiId, LanguageCode, DeviceType, ViewedAt) VALUES (N'view-9', N'poi-snail-signature', N'ja', N'android', CAST(N'2026-03-17T11:20:00+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.ViewLogs (Id, PoiId, LanguageCode, DeviceType, ViewedAt) VALUES (N'view-11', N'poi-bbq-night', N'vi', N'android', CAST(N'2026-03-18T12:45:00+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.ViewLogs (Id, PoiId, LanguageCode, DeviceType, ViewedAt) VALUES (N'view-12', N'poi-snail-signature', N'en', N'ios', CAST(N'2026-03-18T18:25:00+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.ViewLogs (Id, PoiId, LanguageCode, DeviceType, ViewedAt) VALUES (N'view-14', N'poi-bbq-night', N'en', N'ios', CAST(N'2026-03-19T09:40:00+00:00' AS datetimeoffset(7)));
GO
INSERT INTO dbo.AudioListenLogs (Id, PoiId, LanguageCode, ListenedAt, DurationInSeconds) VALUES (N'listen-1', N'poi-bbq-night', N'vi', CAST(N'2026-03-13T11:30:00+00:00' AS datetimeoffset(7)), 96);
INSERT INTO dbo.AudioListenLogs (Id, PoiId, LanguageCode, ListenedAt, DurationInSeconds) VALUES (N'listen-2', N'poi-snail-signature', N'en', CAST(N'2026-03-14T12:10:00+00:00' AS datetimeoffset(7)), 88);
INSERT INTO dbo.AudioListenLogs (Id, PoiId, LanguageCode, ListenedAt, DurationInSeconds) VALUES (N'listen-4', N'poi-bbq-night', N'zh-CN', CAST(N'2026-03-15T19:00:00+00:00' AS datetimeoffset(7)), 110);
INSERT INTO dbo.AudioListenLogs (Id, PoiId, LanguageCode, ListenedAt, DurationInSeconds) VALUES (N'listen-5', N'poi-snail-signature', N'vi', CAST(N'2026-03-16T18:15:00+00:00' AS datetimeoffset(7)), 102);
INSERT INTO dbo.AudioListenLogs (Id, PoiId, LanguageCode, ListenedAt, DurationInSeconds) VALUES (N'listen-7', N'poi-bbq-night', N'en', CAST(N'2026-03-18T20:20:00+00:00' AS datetimeoffset(7)), 91);
INSERT INTO dbo.AudioListenLogs (Id, PoiId, LanguageCode, ListenedAt, DurationInSeconds) VALUES (N'listen-8', N'poi-snail-signature', N'ja', CAST(N'2026-03-18T20:55:00+00:00' AS datetimeoffset(7)), 95);
INSERT INTO dbo.AudioListenLogs (Id, PoiId, LanguageCode, ListenedAt, DurationInSeconds) VALUES (N'listen-10', N'poi-bbq-night', N'vi', CAST(N'2026-03-19T10:15:00+00:00' AS datetimeoffset(7)), 118);
GO
...
INSERT INTO dbo.AuditLogs (Id, ActorName, ActorRole, [Action], TargetValue, CreatedAt) VALUES (N'audit-b368a6a2', N'Ánh Xuân', N'SYSTEM', N'Cap nhat audio guide', N'poi:vi:poi-bbq-night', CAST(N'2026-03-23T15:09:14.7662388+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.AuditLogs (Id, ActorName, ActorRole, [Action], TargetValue, CreatedAt) VALUES (N'audit-465e19bf', N'Ánh Xuân', N'SYSTEM', N'Cap nhat noi dung thuyet minh', N'poi:vi:poi-bbq-night', CAST(N'2026-03-23T15:09:14.7036302+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.AuditLogs (Id, ActorName, ActorRole, [Action], TargetValue, CreatedAt) VALUES (N'audit-4d658113', N'Ánh Xuân', N'SYSTEM', N'Cap nhat POI', N'quang-truong-am-thuc-bbq-night', CAST(N'2026-03-23T15:09:14.674846+00:00' AS datetimeoffset(7)));
...
INSERT INTO dbo.AuditLogs (Id, ActorName, ActorRole, [Action], TargetValue, CreatedAt) VALUES (N'audit-3ee8b781', N'Ánh Xuân', N'SYSTEM', N'Tao noi dung thuyet minh', N'poi:zh-CN:poi-bbq-night', CAST(N'2026-03-21T03:10:22.6482714+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.AuditLogs (Id, ActorName, ActorRole, [Action], TargetValue, CreatedAt) VALUES (N'audit-58bd5af3', N'Ánh Xuân', N'SYSTEM', N'Tao audio guide', N'poi:zh-CN:poi-bbq-night', CAST(N'2026-03-21T03:10:22.6043302+00:00' AS datetimeoffset(7)));
...
INSERT INTO dbo.AuditLogs (Id, ActorName, ActorRole, [Action], TargetValue, CreatedAt) VALUES (N'audit-dd447361', N'Minh Ánh', N'SYSTEM', N'Cap nhat noi dung thuyet minh', N'poi:vi:poi-bbq-night', CAST(N'2026-03-21T02:26:09.7445932+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.AuditLogs (Id, ActorName, ActorRole, [Action], TargetValue, CreatedAt) VALUES (N'audit-a967b25e', N'Minh Ánh', N'SYSTEM', N'Cap nhat POI', N'quang-truong-am-thuc-bbq-night', CAST(N'2026-03-21T02:26:09.7190989+00:00' AS datetimeoffset(7)));
...
INSERT INTO dbo.AuditLogs (Id, ActorName, ActorRole, [Action], TargetValue, CreatedAt) VALUES (N'audit-952ca80d', N'Ánh Xuân', N'SYSTEM', N'Cap nhat noi dung thuyet minh', N'poi:vi:poi-bbq-night', CAST(N'2026-03-21T00:53:15.4587231+00:00' AS datetimeoffset(7)));
INSERT INTO dbo.AuditLogs (Id, ActorName, ActorRole, [Action], TargetValue, CreatedAt) VALUES (N'audit-43ec5465', N'Ánh Xuân', N'SYSTEM', N'Cap nhat audio guide', N'poi:vi:poi-bbq-night', CAST(N'2026-03-21T00:53:15.4148852+00:00' AS datetimeoffset(7)));
...
INSERT INTO dbo.AuditLogs (Id, ActorName, ActorRole, [Action], TargetValue, CreatedAt) VALUES (N'audit-2', N'Minh Ánh', N'PLACE_OWNER', N'Cập nhật audio tiếng Anh cho BBQ Night', N'poi-bbq-night', CAST(N'2026-03-19T03:05:00+00:00' AS datetimeoffset(7)));
