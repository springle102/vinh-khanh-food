...
public sealed class AppLanguageService : IAppLanguageService
{
    ...
    private static readonly IReadOnlyDictionary<string, string> SeedEnglishTexts =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["login_backend_unavailable"] = "The app could not reach the configured backend to verify this customer profile. Please check ApiBaseUrl and try again.",
            ["login_button"] = "Login",
            ...
            ["settings_contact_title"] = "Contact / Complaints",
            ["settings_contact_open"] = "Open",
            ["settings_contact_hide"] = "Hide",
            ["settings_contact_system_name"] = "System",
            ["settings_contact_phone"] = "Phone",
            ["settings_contact_email"] = "Email",
            ["settings_contact_address"] = "Address",
            ["settings_contact_support_hours"] = "Support hours",
            ["settings_contact_instructions"] = "Instructions",
            ["settings_contact_not_updated"] = "Not updated",
            ["settings_load_error"] = "Unable to load fresh settings. The app is showing cached data if available.",
            ["settings_contact_load_error"] = "Unable to load contact information right now. Please try again.",
            ["settings_auto_narration_section"] = "Auto audio",
            ...
            ["settings_feedback_section"] = "Complaints & feedback",
            ["settings_contact_updated"] = "Updated: {0}",
